 ...
 */
[_SYM] = KEYMAP( \
  _______, KC_F1, KC_F2,  KC_F3,  KC_F4,  CGX, QWERTY, _______, KC_LPRN, KC_RPRN, _______, _______, \
  _______, KC_F5, KC_F6,  KC_F7,  KC_F8,  _______,  _______,     _______, KC_LBRC, KC_RBRC, _______, _______, \
...
[_QWERTY] = KEYMAP( \
  ...
  KC_LCTL, KC_LGUI, KC_LALT, TT(_SYM), KC_LSFT,  TT(_MOUSE),  TT(_NUM),  KC_SPC,   KC_DEL, KC_VOLD, KC_VOLU, KC_ESC \
)
};
